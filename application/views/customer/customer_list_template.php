...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1> Customer Listing <small>Control panel</small> </h1>
    <ol class="breadcrumb">
...
function trash(id){
   	...
   	$("#element_overlapT").LoadingOverlay("show");
 				...
 				$.ajax({
						  ...
						  url: '<?=base_url('customer/trash?id=')?>'+id,
...
function status(id,status){
   	...
   	$("#element_overlapT").LoadingOverlay("show");
 				...
 				$.ajax({
						  ...
						  url: '<?=base_url('customer/status?id=')?>'+id+'&status='+status,
...
function block(id,status){
	...
	if(status == 2){
		...
		str='Are you sure this Customer blocked !';

	}if(status == 1){

		str='Are you sure this Customer unblock !';
